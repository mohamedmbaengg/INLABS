            ...
            <div className="container">
                ...
                <div className="space-y-12" style={{ display: 'flex', flexDirection: 'column', gap: '3rem' }}>
                    ...
                    <div className="glass-panel" style={{ padding: '2rem' }}>
                        ...
                        <p className="mb-4 text-gray-700">Hands-on problem-solving tools that teach sustainability, ESG, leadership, and financial planning using cards, tokens, dice, and real-world scenarios.</p>
                    </div>
                    ...
                    <div className="glass-panel" style={{ padding: '2rem' }}>
                        ...
                        <p className="mb-4 text-gray-700">Interactive browser/mobile simulations where participants manage virtual organisations, experience market shocks, and analyse KPI outcomes in real time.</p>
                    </div>
                    ...
                    <div className="glass-panel" style={{ padding: '2rem' }}>
                        ...
                        <p className="mb-4 text-gray-700">High-fidelity immersive environments replicating cities, utilities, hotels, and industrial systems.</p>
